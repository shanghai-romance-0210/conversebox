        ...
        <div className="md:w-1/2 flex flex-col justify-center md:mr-8">
          ...
          {user ? (
            <Link href="/search" className="mt-8">
              <p className="w-full px-4 py-2 rounded-full text-center bg-purple-600 text-white font-semibold w-fit active:scale-90 duration-200 select-none cursor-pointer">動画を検索する</p>
            </Link>
          ) : null}
        </div>
